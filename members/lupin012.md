...
* [Review] [Review on: rpc, node: fix nil-pointer panic in gzip batch flush race](https://github.com/erigontech/erigon/pull/22338#pullrequestreview-4662575994) - 2026-07-09
* [Review] [Review on: rpc: fix prestate tracer zero slots](https://github.com/erigontech/erigon/pull/22248#pullrequestreview-4662502478) - 2026-07-09
...
* [Review] [Review on: rpc: refactor NewBaseApi to take BaseApiConfig struct](https://github.com/erigontech/erigon/pull/22478#pullrequestreview-4716877934) - 2026-07-16
* [Pull Request] [rpc: apply BaseFeePerGas block override on pre-London blocks](https://github.com/erigontech/erigon/pull/22536) - 2026-07-16
* [Commit] [rpc: refactor NewBaseApi to take BaseApiConfig struct (#22478)](https://github.com/erigontech/erigon/commit/300772b1c974cc1b35b291ab078ef0c07c98b075) - 2026-07-16
* [Pull Request] [rpc: allow eth_getProof at genesis block](https://github.com/erigontech/erigon/pull/22552) - 2026-07-17
* [Commit] [rpc: apply BaseFeePerGas block override on pre-London blocks (#22536)](https://github.com/erigontech/erigon/commit/15e8252f88d66090485eda8b5f17c37a15db79b6) - 2026-07-17
* [Pull Request] [[WIP] publish SYNCING event on sync state changes](https://github.com/erigontech/erigon/pull/22570) - 2026-07-18
* [Pull Request] [cmd/utils/app, node/debug: fix --config not applied to subcommands](https://github.com/erigontech/erigon/pull/22546) - 2026-07-19
* [Commit] [cmd/utils/app, node/debug: fix --config not applied to subcommands (#22546)](https://github.com/erigontech/erigon/commit/9ddd4296dc009d233eaa8f8acd1d2a1d27d94dc6) - 2026-07-19
...
* [Pull Request] [rpc: match JWT auth-scheme case-insensitively](https://github.com/erigontech/erigon/pull/22773) - 2026-07-27
...
* [Pull Request] [[r3.5] db/state: CP route receipt domain reads through overlay DomainReader](https://github.com/erigontech/erigon/pull/22951) - 2026-08-02
...
* [Pull Request] [rpc/jsonrpc: replay originally failed txns in overlay_getLogs when state overrides are present](https://github.com/erigontech/erigon/pull/23133) - 2026-08-09
* [Pull Request] [rpc:  trace_callMany carry state to next call also when stateDiff not req](https://github.com/erigontech/erigon/pull/23121) - 2026-08-09
* [Review] [Review on: execution/stagedsync: hand the trace sets to the apply result instead of copying](https://github.com/erigontech/erigon/pull/23092#pullrequestreview-4890701300) - 2026-08-09
...
* [Pull Request] [rpc: resolve eth_getLogs and trace_filter tags on the committed view](https://github.com/erigontech/erigon/pull/23279) - 2026-08-14
* [Review] [Review on: rpc: fix eth_getFilterLogs to match eth_getLogs with same criteria](https://github.com/erigontech/erigon/pull/23296#pullrequestreview-4944316861) - 2026-08-15
* [Pull Request] [cmd/rpctest: extract latestBlockNumber helper](https://github.com/erigontech/erigon/pull/23312) - 2026-08-15
* [Pull Request] [rpc/jsonrpc: gate receipts and logs on the data they actually read](https://github.com/erigontech/erigon/pull/23322) - 2026-08-16
...
* [Review] [Review on: rpc/jsonrpc: gate receipts and logs on the data they actually read](https://github.com/erigontech/erigon/pull/23322#pullrequestreview-4965647504) - 2026-08-18
...
* [Pull Request] [rpc/jsonrpc, rpc/gasprice: gate block-data and replay endpoints on the data they read](https://github.com/erigontech/erigon/pull/23760) - 2026-09-02
...
* [Pull Request] [QA: update execution apis ref 6570b55](https://github.com/erigontech/erigon/pull/23873) - 2026-09-08
...
* [Review] [Review on: rpc: encode eth_getLogs results and log subscriptions without reflection](https://github.com/erigontech/erigon/pull/23975#pullrequestreview-5200075549) - 2026-09-14
* [Pull Request] [rpc/jsonrpc: apply trace_call state overrides to the stateDiff baseline](https://github.com/erigontech/erigon/pull/23995) - 2026-09-14
* [Pull Request] [tracing: remove leftover pre-hooks tracer methods](https://github.com/erigontech/erigon/pull/23994) - 2026-09-14
...
* [Commit] [rpc: expose testing_ namespace via --http.api on port 8545 (#20482)](https://github.com/erigontech/erigon/commit/e2ab4144edb7dba90a7e3c699e8ef3c66b36ba5a) - 2026-04-13
* [Review] [Review on: QA: re-enable debug_accountRange and debug_storageRangeAt RPC integration tests](https://github.com/erigontech/erigon/pull/20557#pullrequestreview-4108599441) - 2026-04-14
* [Pull Request] [rpc : optimize eth_getLogs](https://github.com/erigontech/erigon/pull/20561) - 2026-04-14
* [Review] [Review on: rpc : optimize eth_getLogs](https://github.com/erigontech/erigon/pull/20561#pullrequestreview-4110983669) - 2026-04-15
* [Pull Request] [rpc: fix testing build block v1 according Hive Test](https://github.com/erigontech/erigon/pull/20592) - 2026-04-15
...
* [Review] [Review on: rpc: compression with libdeflate](https://github.com/erigontech/erigon/pull/20665#pullrequestreview-4175242359) - 2026-04-25
* [Pull Request] [rpc: fix prestateTracer diff mode missing deleted accounts](https://github.com/erigontech/erigon/pull/20807) - 2026-04-25
* [Pull Request] [QA: enable test also on http-compressed and websockets for historical mainnet](https://github.com/erigontech/erigon/pull/20815) - 2026-04-25
* [Commit] [rpc align debug trace flags with execution-apis spec (#762) (#20755)](https://github.com/erigontech/erigon/commit/7d7ceebc7f34d50f7d121710036765aa659759f1) - 2026-04-25
* [Pull Request] [CI: centralise RPC_VERSION in workflow env and fix rpc-tests cache stale files](https://github.com/erigontech/erigon/pull/20824) - 2026-04-26
* [Review] [Review on: rpc: reject empty BatchCall](https://github.com/erigontech/erigon/pull/20761#pullrequestreview-4177471700) - 2026-04-26
* [Review] [Review on: rpc/jsonrpc: resolve block number before checkPruneHistory](https://github.com/erigontech/erigon/pull/20589#pullrequestreview-4177458951) - 2026-04-26
...
* [Review] [Review on: rpc/jsonrpc: fix base fee too low error code ](https://github.com/erigontech/erigon/pull/21418#pullrequestreview-4362867109) - 2026-05-26
* [Review] [Review on: node/cli: register --rpc.logs.maxresults in DefaultFlags so it takes effect via CLI](https://github.com/erigontech/erigon/pull/21426#pullrequestreview-4365730959) - 2026-05-26
...
* [Pull Request] [QA rpc_int: add tee -a to capture the 3 iterations not only the last one](https://github.com/erigontech/erigon/pull/21736) - 2026-06-10
...
* [Pull Request] [rpc: impl eth fill transaction](https://github.com/erigontech/erigon/pull/21870) - 2026-06-17
* [Issue] [implement eth_fillTransaction](https://github.com/erigontech/erigon/issues/21864) - 2026-06-17
...
* [Commit] [integration: update disablememory->enableMemory in debug_trace* test.tar (#551)](https://github.com/erigontech/rpc-tests/commit/9b024e4ae754b1957368f061b5f695facef5a868) - 2026-04-25
...
* [Pull Request] [perf: add --process-name flag for server liveness check](https://github.com/erigontech/rpc-tests/pull/543) - 2026-03-28
* [Pull Request] [integration: fix exp eth_createAccessList via grpc](https://github.com/erigontech/rpc-tests/pull/542) - 2026-03-28
* [Pull Request] [integration-test: fix exp debug trace transaction tx not found](https://github.com/erigontech/rpc-tests/pull/541) - 2026-03-28
* [Pull Request] [integration: fix debug trace transaction with hex index](https://github.com/erigontech/rpc-tests/pull/538) - 2026-03-28
* [Pull Request] [integration: save expected resp order like erigon](https://github.com/erigontech/rpc-tests/pull/540) - 2026-03-28
* [Pull Request] [integration: compresss ots_searchTransactionsBefore resp](https://github.com/erigontech/rpc-tests/pull/539) - 2026-03-28
* [Pull Request] [rpc-integration: fix json compare with array](https://github.com/erigontech/rpc-tests/pull/537) - 2026-03-28
* [Commit] [fix exp fot debug_traceTransaction with hexIndex (#538)](https://github.com/erigontech/rpc-tests/commit/ec2218cfab9266f43bc751b456fd4363e95fcb3d) - 2026-03-28
* [Commit] [integration: save expected resp order like erigon (#540)](https://github.com/erigontech/rpc-tests/commit/aea385cc4d9b5282d7801f7fb61aad7d4fe0cf19) - 2026-03-28
