...
* [Review] [Review on: chore(tests): improve EIP-8024 coverage, checklist, and ref-spec pin](https://github.com/ethereum/execution-specs/pull/3224#pullrequestreview-4807166235) - 2026-07-29
* [Review] [Review on: feat(tests): implement eip-8070 sparse blob pool tests](https://github.com/ethereum/execution-specs/pull/2948#pullrequestreview-4811296114) - 2026-07-29
* [Pull Request] [fix(test-execute): prune fork-less items before evaluating filter_combinations](https://github.com/ethereum/execution-specs/pull/3259) - 2026-07-29
* [Review] [Review on: fix(tests): enhance & un-skip Amsterdam ported static tests (Pt. 1)](https://github.com/ethereum/execution-specs/pull/3215#pullrequestreview-4810780388) - 2026-07-29
* [Review] [Review on: refactor(ci): run geth benchmark CI only on `benchmarks/**` branches](https://github.com/ethereum/execution-specs/pull/3249#pullrequestreview-4805847550) - 2026-07-29
...
* [Pull Request] [feat(specs): EIP-8146 block access list sidecar delivery](https://github.com/ethereum/execution-specs/pull/3387) - 2026-08-17
* [Pull Request] [feat(spec-specs, tests): EIP-4758 deactivate SELFDESTRUCT (SENDALL)](https://github.com/ethereum/execution-specs/pull/3386) - 2026-08-17
* [Pull Request] [feat(spec-specs, tests): implement EIP-8268 storage roots in block access lists](https://github.com/ethereum/execution-specs/pull/3388) - 2026-08-17
...
* [Review] [Review on: feat(spec-specs, tests): EIP-8037 - zero execution state gas on top-level failure](https://github.com/ethereum/execution-specs/pull/2689#pullrequestreview-4130500106) - 2026-04-17
* [Pull Request] [feat(spec-specs, tests): EIP-8037 - immutable intrinsic state gas for EIP-7702](https://github.com/ethereum/execution-specs/pull/2711) - 2026-04-17
...
* [Review] [Review on: refactor(specs): 8037 `StateGas`, `RegularGas` and `StateGasPerByte`](https://github.com/ethereum/execution-specs/pull/3037#pullrequestreview-4602593742) - 2026-06-30
* [Review] [Review on: chore(ci): speed up bench-gas by filling only the `blockchain_test` format](https://github.com/ethereum/execution-specs/pull/3057#pullrequestreview-4601976459) - 2026-06-30
* [Review] [Review on: refactor(test-benchmark): speed-up the keccak max-permutations search](https://github.com/ethereum/execution-specs/pull/3060#pullrequestreview-4601588798) - 2026-06-30
* [Issue] [Merge Glamsterdam Devnet 6 to Forks/Amsterdam](https://github.com/ethereum/execution-specs/issues/3068) - 2026-06-30
* [Issue] [Enforce merged EIP reference-spec pins as a release gate](https://github.com/ethereum/execution-specs/issues/3065) - 2026-06-30
...
[ethereum/go-ethereum](https://github.com/ethereum/go-ethereum)
* [Pull Request] [core: fix bal-devnet-3 hive failures](https://github.com/ethereum/go-ethereum/pull/34105) - 2026-03-27
## Q4 2025
...
* [Commit] [feat(forks|consume): bpo framework requirements (#2050)](https://github.com/ethereum/execution-spec-tests/commit/6fd90a8b6de374635ff8d5d75efd77476d72e019) - 2025-08-19
* [Commit] [chores(fill): remove --flat-output and all logic associated with it (#2018)](https://github.com/ethereum/execution-spec-tests/commit/cfd83387efab95876de839a69554fba347ef37c7) - 2025-08-19
