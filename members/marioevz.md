...
* [Review] [Review on: feat(tests): EIP-6110 maximum CL deposits test](https://github.com/ethereum/execution-specs/pull/3483#pullrequestreview-5096412076) - 2026-09-02
* [Review] [Review on: chore(test-specs): avoid silent mistakes when writing tests](https://github.com/ethereum/execution-specs/pull/3510#pullrequestreview-5095019741) - 2026-09-02
...
* [Review] [Review on: feat: add more invalid BAL test cases; extend invalid case coverage](https://github.com/ethereum/execution-specs/pull/2653#pullrequestreview-4108751340) - 2026-04-14
* [Pull Request] [feat(test-forks): enable multiple EIP to be specified in `fork.is_eip_enabled`](https://github.com/ethereum/execution-specs/pull/2676) - 2026-04-14
* [Review] [Review on: feat(src): devnet merger script + fix for conflict-free merges](https://github.com/ethereum/execution-specs/pull/2663#pullrequestreview-4106199543) - 2026-04-14
...
* [Review] [Review on: feat(spec-specs, tests): Add EIP-8024 Backward compatible SWAPN, DUPN, EXCHANGE](https://github.com/ethereum/execution-specs/pull/2881#pullrequestreview-4323141494) - 2026-05-19
...
* [Review] [Review on: fix(test-benchmark): update `approve` function for `SSTORE` benchmark](https://github.com/ethereum/execution-specs/pull/2487#pullrequestreview-3938156164) - 2026-03-12
...
* [Pull Request] [feat(test-forks): Add EIP classes](https://github.com/ethereum/execution-specs/pull/2571) - 2026-03-26
* [Review] [Review on: fix(src): restore` execute` chain-id defaults after in-process pytest runs](https://github.com/ethereum/execution-specs/pull/2567#pullrequestreview-4017382666) - 2026-03-26
...
* [Commit] [chore(cli): consume direct geth blocktest fail fix (#1502)](https://github.com/ethereum/execution-spec-tests/commit/2cc73e36ae58f31131660f8b6f018648468ca1fa) - 2025-04-28
...
* [Commit] [refactor: optimize jumpdest test case (#1732)](https://github.com/ethereum/execution-spec-tests/commit/43e710c34e40c9ac6ce3e22a8206571bfed2cdd7) - 2025-06-14
* [Commit] [fix(tests): Fix test_worst_selfdestruct_created (#1741)](https://github.com/ethereum/execution-spec-tests/commit/9c75235581a4af8c3e12174b98c83cd9acc8df89) - 2025-06-14
...
[ethereum/eips](https://github.com/ethereum/eips)
* [Pull Request] [Update EIP-7907: Account for large contracts as tx entry point](https://github.com/ethereum/EIPs/pull/9955) - 2025-06-30
## Q1 2025

[ethereum/execution-spec-tests](https://github.com/ethereum/execution-spec-tests)
* [Commit] [refactor(plugins/execute): Refactor account refunds logic (#1204)](https://github.com/ethereum/execution-spec-tests/commit/f28f786070d6006214a6e92496a31c3f9b62f8ca) - 2025-03-18
* [Pull Request] [fix(cli/gen_index): Fix index generation for EOF files](https://github.com/ethereum/execution-spec-tests/pull/1332) - 2025-03-19
* [Commit] [fix(consume): fix loading of multi-index, mixed tx type fixtures (#1330)](https://github.com/ethereum/execution-spec-tests/commit/286c026768b11bdef6f37c71760823adb0579917) - 2025-03-19
* [Commit] [More changes](https://github.com/ethereum/execution-spec-tests/commit/b2e5b5821d9a2d52613750e564e22d258d081587) - 2025-03-21
* [Commit] [chore(consume): fix `--sim.limit` in hive commands shown in test reports (#1333)](https://github.com/ethereum/execution-spec-tests/commit/d4b536d466a1671f309c201efa71fe3ebed4f8ed) - 2025-03-21
* [Commit] [fix(consume): fix loading of multi-index, mixed tx type fixtures (#1330)](https://github.com/ethereum/execution-spec-tests/commit/286c026768b11bdef6f37c71760823adb0579917) - 2025-03-21
* [Commit] [chore(ci): pin github actions as hashed versions (#1334)](https://github.com/ethereum/execution-spec-tests/commit/271fe2e7c7d8f30e99e8dcb2b012c7588daebfdd) - 2025-03-21
* [Commit] [chore(ci): explicity define version range for `pycryptodome`. (#1343)](https://github.com/ethereum/execution-spec-tests/commit/af77f5293dfab7275e2e3629a5d4a90afa3ee0fa) - 2025-03-24
