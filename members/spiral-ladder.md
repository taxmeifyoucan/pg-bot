...
Github: [@spiral-ladder](https://github.com/spiral-ladder)
...
* [Review] [Review on: fix(bls): preserve aggregate outputs on failure](https://github.com/ChainSafe/lodestar-z/pull/521#pullrequestreview-4755104354) - 2026-07-22
* [Review] [Review on: fix(bls): reject empty keygen salts](https://github.com/ChainSafe/lodestar-z/pull/524#pullrequestreview-4758371900) - 2026-07-22
...
* [Pull Request] [fix(state-transition): use getReadonly for read-only validator access](https://github.com/ChainSafe/lodestar-z/pull/712) - 2026-09-17
...
[ChainSafe/lodestar-z](https://github.com/ChainSafe/lodestar-z)
* [Pull Request] [feat: multi-threaded bls for lodestar integration](https://github.com/ChainSafe/lodestar-z/pull/306) - 2026-04-07
* [Review] [Review on: feat: multi-threaded bls for lodestar integration](https://github.com/ChainSafe/lodestar-z/pull/306#pullrequestreview-4068875489) - 2026-04-07
* [Pull Request] [chore: fix zapi usage](https://github.com/ChainSafe/lodestar-z/pull/307) - 2026-04-07
* [Review] [Review on: chore: fix zapi usage](https://github.com/ChainSafe/lodestar-z/pull/307#pullrequestreview-4069060542) - 2026-04-07
...
* [Pull Request] [test: per-target spec tests](https://github.com/ChainSafe/lodestar-z/pull/317) - 2026-04-15
* [Pull Request] [ci: run mainnet spectests on 4core](https://github.com/ChainSafe/lodestar-z/pull/316) - 2026-04-15
* [Pull Request] [ci: run ssz_static minimal spec tests and general mainnet spec tests on `ReleaseSafe`](https://github.com/ChainSafe/lodestar-z/pull/315) - 2026-04-15
...
* [Review] [Review on: perf(ssz): bulk memcpy for uint list/vector on little-endian](https://github.com/ChainSafe/lodestar-z/pull/291#pullrequestreview-4127903676) - 2026-04-17
...
* [Review] [Review on: fix: native metrics example](https://github.com/ChainSafe/lodestar-z/pull/239#pullrequestreview-3952324952) - 2026-03-16
